...
var sagev2ItemActive_1 = require("src/components/sagev2ItemActive/sagev2ItemActive");
...
function SageV2Detail() {
    ...
    //贡献值
    var _j = react_1.useState('0'), contributionSingle = _j[0], setContributionSingle = _j[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 8:
                    ...
                    x3ethValue = parseFloat(levelData.x3eth) + 0.01;
                    reopen = x3ethValue / (1.6 * levelData.levelPrice);
    ...
    var doStart = function (level) {
        doBuy(level, appConfig_1.sagev2LevelPrices[level - 1]);
    };
    return (react_1["default"].createElement(antd_1.Spin, { spinning: loading },
        ...
        react_1["default"].createElement("div", { className: "dashboard-head" },
            react_1["default"].createElement("div", { className: "wal" },
                react_1["default"].createElement("div", { className: "title" },
                    react_1["default"].createElement("h2", null, "UNISAGE II"),
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("em", null, "Instructions"),
                        react_1["default"].createElement("img", { src: "/assets/image/img24_3.png", alt: "" }))),
                react_1["default"].createElement("div", { className: "box" },
                    react_1["default"].createElement("dl", null,
                        react_1["default"].createElement("dd", null,
                            react_1["default"].createElement("em", null, "My Contribution:"),
                            react_1["default"].createElement("b", null, contributionSingle)),
                        react_1["default"].createElement("dd", null,
                            react_1["default"].createElement("em", null, "Total Contribution:"),
                            react_1["default"].createElement("b", null, contributionTotal)))))),
        react_1["default"].createElement("div", { className: "sagev2_dashboard" },
            react_1["default"].createElement("div", { className: "wal" },
                ...
                react_1["default"].createElement("div", { className: "container wow fadeInUp" },
                    react_1["default"].createElement("h2", null, "My UNISAGE II"),
                ...
                react_1["default"].createElement("div", { className: "list" },
                    react_1["default"].createElement("h2", { className: "wow fadeInUp" }, "slots level"),
                    react_1["default"].createElement("ul", null, sageDataSource ? sageDataSource.map(function (levelData, index) {
                        ...
                        return (react_1["default"].createElement(sagev2ItemActive_1["default"], { data: levelData, showStart: ifshow, key: index, startAction: function () {
